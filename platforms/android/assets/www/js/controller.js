(function(){
	var app = angular.module('Controller',['ionic','ngRoute']);

	app.controller('AppController',function($scope,$ionicModal,$routeParams) {
	    ...
	    var doNotGroup = function() {
	    	$scope.displayData = $scope.filteredData;
	    };
	    ...
	    //$scope.$watch('settings',function(){
       	//	$scope.produceAlerts();
       	//	console.log($scope.settings.limitMax);
        //},true);
	});
})();